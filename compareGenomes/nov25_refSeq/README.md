...
The biggest difference that I see chromosomal rearrangements and a reduction in duplications (from ~20% to 1.3%). These scripts serve to:
1. re-align my sequences to the new reference
2. compare the outputs from the two genomes
